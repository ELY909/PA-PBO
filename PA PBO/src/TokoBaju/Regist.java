...
public class Regist extends javax.swing.JFrame {
    ...
    String kpwString = new String(kpw);

    // Check for spaces in username and password
    if (usn.contains(" ") || pwString.contains(" ") || kpwString.contains(" ")) {
        JOptionPane.showMessageDialog(this, "Username dan password tidak boleh mengandung spasi.", "Input Error", JOptionPane.ERROR_MESSAGE);
        return;
    }
